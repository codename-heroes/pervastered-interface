...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GrabberError'
        db.create_table('Logger_grabbererror', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('grabber', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Logger.InfoGrabber'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('error', self.gf('django.db.models.fields.TextField')()),
            ('updater', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Logger.Updater'])),
        ))
        db.send_create_signal('Logger', ['GrabberError'])

        # Adding field 'TriggerError.updater'
        db.add_column('Logger_triggererror', 'updater',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Logger.Updater']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'GrabberError'
        db.delete_table('Logger_grabbererror')

        # Deleting field 'TriggerError.updater'
        db.delete_column('Logger_triggererror', 'updater_id')
    ...
    models = {
        ...
        'Logger.grabbererror': {
            ...
            'grabber': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Logger.InfoGrabber']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
