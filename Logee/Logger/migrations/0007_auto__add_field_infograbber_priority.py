...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InfoGrabber.priority'
        db.add_column('Logger_infograbber', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InfoGrabber.priority'
        db.delete_column('Logger_infograbber', 'priority')
