...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TriggerError.checked'
        db.add_column('Logger_triggererror', 'checked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'GrabberError.checked'
        db.add_column('Logger_grabbererror', 'checked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TriggerError.checked'
        db.delete_column('Logger_triggererror', 'checked')

        # Deleting field 'GrabberError.checked'
        db.delete_column('Logger_grabbererror', 'checked')
