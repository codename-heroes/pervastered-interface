...
function markerClicked() {
    /*$(document).mousemove(
        function(e) {
            var marker = $('.timeline-range-marker-a');
            marker.mousedown(
                // Victor
            );


                .css({left:((e.pageY).toFixed(1)/800.0*100.0)+'%'});
        }
    );
    $(document)*/
};
...
links.Timeline.prototype.repaintFrame = function() {
    ...
    if (!dom.frame) {
        ...
        toolbar.className = "vco-toolbar";
        
        var backHome = document.createElement("DIV");
        backHome.className = "back-home";
        backHome.setAttribute("data-toggle", "tooltip");
        backHome.setAttribute("data-original-title","Return to Title");
        backHome.setAttribute("data-placement","right");
        ...
        zoomIn.setAttribute("data-toggle", "tooltip");
        zoomIn.setAttribute("data-original-title","Expand Timeline");
        zoomIn.setAttribute("data-placement","right");
        var icon = document.createElement("DIV");
        icon.className = "icon";
        ...
        zoomOut.setAttribute("data-toggle", "tooltip");
        zoomOut.setAttribute("data-original-title","Contract Timeline");
        zoomOut.setAttribute("data-placement","right");
        var icon = document.createElement("DIV");
        icon.className = "icon";
        zoomOut.appendChild(icon);
        
        toolbar.appendChild(backHome);
        toolbar.appendChild(zoomIn);
        toolbar.appendChild(zoomOut);
        dom.frame.appendChild(toolbar);
        ...
        var timenavIndicatorA = document.createElement("DIV");
        timenavIndicatorA.className = "timeline-range-marker-a";
        dom.frame.appendChild(timenavIndicatorA);
        //timenavIndicatorA.setAttribute("onclick", ");
        
        var timenavTop  = document.createElement("DIV");
        timenavTop.className = "timenav-top";
        dom.frame.appendChild(timenavTop);
        dom.frame.appendChild(timenavLine);
        dom.frame.appendChild(timenavIndicator);
...
links.Timeline.prototype.onMouseMove = function (event) {
    ...
    if (this.options["orientation"] == "vertical") {
        var diffX = mouseX - params.mouseY;
        var diffY = mouseY - params.mouseX;
    } else {
